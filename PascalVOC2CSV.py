# -*- coding: utf-8 -*-
"""
Created on Fri Nov 20 19:17:25 2020
...
def parse_args():
    ...
    parser.add_argument('-t', '--train', type=str, default='test.csv')
...
if __name__ == "__main__":
    ...
    Annotations = get_file_index('./annotations_VOC/train', '.xml') 
    Annotations.sort()
    JPEGfiles = get_file_index('./train', '.png') #可根据自己数据集图片后缀名修改 这是你VOC数据集的JPEGImage的路径 每一人路径不一样 我一般用的就是绝对路径
    JPEGfiles.sort()
